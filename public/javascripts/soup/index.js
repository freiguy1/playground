var viewModel = new SoupViewModel();
...
function SoupViewModel() {
    ...
    self.addEntry = {
        ...
        addSoupConfirmation: ko.observable(false)
    };
    ...
    self.addEntryClicked = function() {
        ...
        self.addEntry.addSoupConfirmation(false)
    ...
    self.addEntryModalClicked = function() {
        ...
        adminAjax.addEntry({
            ...
            self.addEntry.editUrl("http://" + window.location.host + "/soup/" + data.uuid)
            self.addEntry.addSoupConfirmation(true)
            self.initialize()
        }).fail(function() {
